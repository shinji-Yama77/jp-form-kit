...
`variants` は、同じレイアウトを共有する別言語版 PDF のための補助情報です。
...
もし日本語版と英語版でレイアウトが異なる場合は、`variants` ではなく別スキーマとして定義してください。座標が異なるフォームを 1 つのスキーマにまとめると、将来的に誤った PDF に描画してしまう原因になります。
