...
export const juminhyoSchema: OverlayFormSchema = {
  ...
  description: "Request a copy of your resident record — required for almost every other procedure",
  variants: [
    {
      lang: "en",
  ...
  fields: [
    ...
    { key: "address",  x: 144, y: 664, labelEn: "Current Address",  labelJa: "現住所",  required: true },
